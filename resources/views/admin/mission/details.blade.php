        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="{{route('missions.index')}}" name="submit" type="submit" class="btn font-weight-bold btn-warning mb-3 px-3 py-2">Trở lại</a>
                            ...
                            <div class="row">
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td style="width: 20%">
                                                    <div class="d-flex justify-content-around">
                                                        <a href="{{ route('missions.edit', ['mission' => $mission]) }}" class="btn btn-info font-weight-bold px-4 py-2">Chỉnh sửa</a>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="text-center border border-width-2 p-4">
                                        @foreach(json_decode($mission->image) as $image)
                                            <img  width="247" height="247" src="{{ asset('storage/images/mission/' . $image) }}" alt="">
                                        @endforeach
                                    </div>
                                </div>
                            </div>
