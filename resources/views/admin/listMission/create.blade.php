...
@section('contents')
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" action="{{ route('listMissions.store') }}" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control" id="title" placeholder="listMission Title ">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="desc" type="text" placeholder="listMission Description "  class="form-control" id="desc">
                </div>
                <div class="form-group">
                    <label for="">Mission Parent</label>
                    <select name="mission_id" class="form-control" id="mission_id">
                        <option value="">Chọn sứ mệnh cha</option>
