        ...
        <form method="post" action="{{ route('sections.store') }}" enctype="multipart/form-data" >
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control" id="title" placeholder="section Title ">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="desc" type="text" placeholder="section Description "  class="form-control" id="desc">
                </div>
